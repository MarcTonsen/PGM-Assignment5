...
RS_student = denoising_grad_ascent_student(NS,sigma,eta,1);
imshow(mat2gray(NS));
waitforbuttonpress;
...
RC_student = denoising_grad_ascent_student(NC,sigma,eta,1);
imshow(mat2gray(NC));
waitforbuttonpress;
...
RI_student = denoising_grad_ascent_student(NI,sigma,eta,1);
imshow(mat2gray(NI));
waitforbuttonpress;
